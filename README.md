...
Spécialités :
- 🧿 **Programming language** : C, C++, PHP, JavaScript, HTML, CSS
- 🧵 **Framework** : Angular, Symfony, Node.Js, Codeligneteur, Smarty
- 🔌 **Systems Architecture** : Unix/Linux kernels, Git
- 💾 **Memory Management** : Modelisation BDD, UML, Architecture logicielle, SQL, NoSQL
